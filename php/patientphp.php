...
try {
	...
	$res = $id->query("SELECT Id, Nom, Email, Age, Tel, Prenom FROM `patient`, compte_kine WHERE patient.Id = compte_kine.id_compte AND `id_kine`='".$Idkine."'"); //sélectionner les données relatives à tous les patiens du kiné connecté 
