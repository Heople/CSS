...
try {
  $Idkine=$_POST['Idkine'];
    ...
    $res = $id->query("SELECT * FROM `patient`, compte_kine WHERE patient.Id = compte_kine.id_compte AND id_kine='".$Idkine."'"); //selectionné les patient dépendants du kiné connecté
